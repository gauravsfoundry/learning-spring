...
public class MyApp {
    public static void main(String[] args) {
        ...
        Coach theCoach = context.getBean("swimCoach", Coach.class); //Using default bean name; casting to class instead of interface because of additional methods in class
